...
Output Data
The resulting dataset includes just mean and standard deviation variables for the following original variables:
...
All three coordinates (X,Y,Z) are included.
